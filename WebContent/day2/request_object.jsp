...
: 메소드값으로 알아낼 수 있는 정보들을 확인하기
 ...
 <hr>
 <!-- 요청url : http://localhost:8082/jsp1/day2/request_object.jsp -->
 <ul>
 ...
 <li>서버의 주소 IP: <%=request.getLocalAddr() %>,<%=request.getLocalName() %></li>
...
request.setCharacterEncoding("UTF-8"); %>
 ...
 <!-- 출력 IPv4로 바꾸는 설정 : Run -> Run Configurations -> tomcat -> Arguments -> VM Arg 에 입력
